...
import net.sf.odinms.server.quest.actions.*;
import net.sf.odinms.server.quest.requirements.*;
...
public class MapleQuest {
    ...
    private final static MapleDataProvider questData = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("net.sf.odinms.wzpath") + "/Quest.wz"));
