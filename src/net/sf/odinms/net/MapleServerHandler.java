...
public class MapleServerHandler extends IoHandlerAdapter {
    ...
    public void exceptionCaught(IoSession session, Throwable cause) throws Exception {
        ...
        if (mc != null && mc.getPlayer() != null) {
            LogSystem.printError(LogSystem.EXCEPTION_CAUGHT, cause, "Exception caught by: " + mc.getPlayer());
        }
    }
    ...
    public void sessionOpened(IoSession session) throws Exception {
        ...
        if (channel > -1) {
            ...
            LogSystem.print(LogSystem.SESSION, "IoSession with " + session.getRemoteAddress() + " opened on " + sdf.format(Calendar.getInstance().getTime()), false);
        }
